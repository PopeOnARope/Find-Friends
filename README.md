...
Tired of not having any friends? Well you're in luck! Find and create your friends on this google-maps-based interface.

Click the markers on the map to view details about existing friends.

Click the `add friend` button to add a new friend. You can specify an image url for the `avatar` field, or use the default image.

Default friends are based on Arrested Development Characters.

## installation

Clone this Repo and run `npm install && npm start` and the app will automatically open on port 3000 in your browser.
